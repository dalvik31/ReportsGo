            ...
            usersRef.child(orderIdList).child("orderLists").child(orderItemId).setValue(orderDetail, new CompletionListener() {
                ...
                public void onComplete(@Nullable DatabaseError databaseError, @NonNull DatabaseReference databaseReference) {
                    if (databaseError != null) {
                        ...
                        if (orderDetail.isOrderBuy()) {
                            orderDetailModelClass.successOrderBuyElement(ReportsApplication.getMyApplicationContext().getString(R.string.lbl_order_update));
                        } else {
                            orderDetailModelClass.successOrderBuyElement(ReportsApplication.getMyApplicationContext().getString(R.string.lbl_order_buy_update));
